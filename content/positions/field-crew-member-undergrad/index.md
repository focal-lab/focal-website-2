...
1. A study of forest recovery 10-40 years post-wildfire that will use drone imagery to develop a
  computer vision model for mapping trees establishing following decades-old fires across southern,
  central, and northern California. This project involves drone flights only, no ground-based
  imagery or manual inventory.
...
Due to the remoteness of the field sites, the crew member should expect to spend up to 7 consecutive
