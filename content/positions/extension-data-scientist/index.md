...
- Develop software tools and analysis workflows to build 3D understory models from 360-degree ground imagery, including assigning object classes (e.g., tree, log, shrub) to the 3D understory model by projecting labels from 2D images by employing (and potentially extending) [Geograypher](https://github.com/open-forest-observatory/geograypher)
