...
- **Field data collection (75%):**
  ...
  - Lead a crew of 2-3 (including crew leader) in collecting ground-based data, including GoPro
  ...
  - Perform work alongside the other crew members while ensuring the crew’s work meets high quality
    standards, correctly follows all protocols, and is conducted safely and efficiently.
...
- **Logistics, travel, safety, and communication (10%):** 
  ...
  compasses
  - Make decisions in the office and the field regarding project logistics and allocation allocation of crew time (e.g.,
